...
<head>
    ...
    <title>Hồ sơ - Giảng viên - Chứng chỉ kỹ năng lái xe an toàn</title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Hồ sơ - Giảng viên</h1>
                </div>
                    ...
                    <div class="card-body">
                        <form action="${pageContext.request.contextPath}/UpdateUserProfileServlet" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="phone" name="phone" class="form-control" value="${user.phone}" pattern="0\d{9}" title="Số điện thoại phải bắt đầu bằng 0 và có đúng 10 chữ số" >
                            </div>
                            <div class="form-group">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="${pageContext.request.contextPath}/UserdashboardServlet?role=teacher" class="btn btn-sm btn-back">Quay lại</a>
                            </div>
                        </form>
                    </div>
                </div>
