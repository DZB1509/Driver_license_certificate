...
<head>
    ...
    <title>Hồ sơ - Học sinh - Chứng chỉ kỹ năng lái xe an toàn</title>
                    ...
                    <div class="card-body">
                        <form action="${pageContext.request.contextPath}/UpdateUserProfileServlet" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="fullName" name="fullName" class="form-control" value="${student.fullName}" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="phone" name="phone" class="form-control" value="${student.phone}" pattern="0\d{9}" title="Số điện thoại phải bắt đầu bằng 0 và có đúng 10 chữ số" >
                            </div>
                            <div class="form-group">
                                <label for="className"><strong>Lớp(optional):</strong></label>
                                <input type="text" id="className" name="className" class="form-control" value="${student.className}" >
                            </div>
                            <div class="form-group">
                                <label for="school"><strong>Trường(optional):</strong></label>
                                <input type="text" id="school" name="school" class="form-control" value="${student.school}" >
                            </div>
                            <div class="d-flex justify-content-between">
                                <button type="submit" class="btn btn-sm btn-save">Lưu thay đổi</button>
                                <a href="${pageContext.request.contextPath}/UserdashboardServlet?role=student" class="btn btn-sm btn-back">Quay lại</a>
                            </div>
                        </form>
                    </div>
                </div>
