...
<html>
    <head>
        ...
        <title>Chứng Chỉ Lái Xe - Đăng Nhập Người Dùng</title>
    </head>
    <body>
        <div class="wrapper">
            <nav class="nav">
            ...
            <div class="form-box">
                <div class="login-container" id="login">
                    <div class="top">
                        <span>Quay lại? <a href="${pageContext.request.contextPath}/login">Chọn vai trò</a></span>
                        <header>Đăng Nhập Người Dùng</header>
                    </div>
